...
class ContratoEntity(db.Model):
    ...
    centro_id: str = db.Column(db.String(36), db.ForeignKey('centro_trabajo.id'), nullable=False)
    operario_id: str = db.Column(db.String(36), db.ForeignKey('operario.id'), nullable=False)
